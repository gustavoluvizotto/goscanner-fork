...
type Options struct {
	...
	Scans      []string `short:"r" long:"scans" description:"A list of scans to run. Choose of starttls_ldap,tls,http,scvs,ssh,ldap,ldap_metadata. Some can be combined like tls,http for https scans. Order is important"`
